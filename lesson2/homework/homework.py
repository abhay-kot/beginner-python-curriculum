...
user = input("Tell me your favorite animal ")
us = input("Tell me your favorite color")
print(user + us)
...
xl = int(input("How many push ups can you do."))
print(xl * 7)
...
#print("You already know why after problem 3")